...
SECRET_KEY = 'django-insecure-j#=&+mk+jwvaazj#vc$6_+45&pulwqr@t@&%7q!fv@n0p8ae_-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['mazda-ford.ru', '127.0.0.1', 'localhost']
...
CSRF_TRUSTED_ORIGINS = ['https://mazda-ford.ru']